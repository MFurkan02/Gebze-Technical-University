...
public class GUIVisualization extends JFrame {
    ...
    /**
     * GUIVisualization constructor to plot the graph according to the given size and operation.
     * @param plotType
     */
    public GUIVisualization(String plotType,int size,String operation) {
        ...
        // first adding some nodes to AVLTree in case remove or search or update is selected.
        for (int i = 0; i < size; i++) {
                    sdm.addOrUpdateStock("SYM" + i+5, Math.random() * 100, (long) (Math.random() * 1000000), (long) (Math.random() * 1000000000));
                }
        ...
        for (int i = 1; i <= size; i+=1) {
            dataPointsX.add(i);
            dataPointsY.add(sdm.performPerformanceAnalysis(sdm, i, operation)/100);
        ...
        setTitle("Performance Graph of ADD Operation"); // Set the title of the window
    ...
    public static void main(String[] args) {
        //SwingUtilities.invokeLater(() -> new GUIVisualization("logarithmic", 1024).setVisible(true));
        /*SwingUtilities.invokeLater(() -> {
            String plotType = "line"; // Change to "scatter" for scatter plot
            GUIVisualization frame = new GUIVisualization(plotType,1000); // Create a new instance of GUIVisualization
