In order to try the other lifecycles in PART B which is lifecycle1(line 101) and lifecycle2(109) should be commented out.
...
You need to install the GNU C++ Compiler, VirtualBox, binuilts, libc6-dev-i386 to be able to compile the code. To install these tools you can do:
    ...
    sudo apt-get install VirtualBox grub-legacy xorriso OR sudo apt-get install virtualbox grub-pc xorriso
