...
namespace myos
{
    ...
    private:
        static const int STACK_SIZE = 4096; // 4 KB 
        ...
        CPUState *cpustate;
        bool waitparent;
        static const int MAX_NUM_TASKS = 256 ;
    public:
    ...
    private:
        ...
        void CopyTask(Task *source, Task *destination);
        void PrintStatusOfTask(int index_of_table);
        void GetTaskStatus();
        void ControlTask();
